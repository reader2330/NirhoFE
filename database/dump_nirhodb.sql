...
(12,'JAPON',1,'NULL',1),
(13,'INDIA',1,'NULL',1),
(14,'HONDURAS',1,'NULL',1),
(15,'VENEZUELA',1,'NULL',1),
(16,'Empresas de Servicios',1,'NULL',2),
(17,'Empresas Industriales',1,'NULL',2),
(18,'Empresa Comerciales',1,'NULL',2),
(19,'Celular',1,'NULL',3),
(20,'Email',1,'NULL',3),
...
(28,'Inglés',1,'NULL',4),
(29,'Japonés',1,'NULL',4),
(30,'Portugués',1,'NULL',4),
(31,'Otro',1,'NULL',4),
(32,'Básico',1,'NULL',5),
(33,'Intermedio',1,'NULL',5),
(34,'Avanzado',1,'NULL',5),
(35,'Bilingüe',1,'NULL',5),
(36,'Técnico',1,'NULL',5),
(37,'Nativo',1,'Primera lengua hablada, total dominio de ella',5),
(38,'Nulo',1,'NULL',6),
(39,'Suficiente',1,'NULL',6),
(40,'Medio',1,'NULL',6),
(41,'Alto',1,'NULL',6),
(42,'Superior',1,'NULL',6),
(43,'Contacto de cobranza',1,'NULL',7),
(44,'Líder de proyecto',1,'NULL',7),
(45,'Entrevistador',1,'NULL',7),
(46,'Nulo',1,'NULL',8),
(47,'Suficiente',1,'NULL',8),
(48,'Medio',1,'NULL',8),
(49,'Alto',1,'NULL',8),
(50,'Superior',1,'NULL',8),
(51,'Actitud de servicio',1,'Disposición de actuar, sentir y/o pensar en torno a las necesidades del cliente para lo cual dirige toda sus acciones como estrategia para garantizar la satisfacción de los mismos.',9),
(52,'Adaptación al medio',1,'Ajustarse a los posibles cambios laborales, sociales y personales, percibiéndolos como oportunidades de aprendizaje.',9),
(53,'Análisis de problemas',1,'Capacidad para trascender de lo lógico a lo abstracto y encontrar las verdaderas causas y soluciones de una situación o problema especifico; cuyos resultados son sustentados con un alto nivel de eficacia y confiabilidad.',9),
(54,'Comunicación efectiva',1,'Es la competencia que posee el líder para escuchar, entender y valorar con empatía información, ideas y opiniones que su equipo le comunique, siendo capaz de retroalimentar asertivamente el proceso comunicativo.',9),
(55,'Comunicación interpersonal',1,'Capacidad para generar y mantener un flujo de comunicación adecuado entre los miembros del grupo o de la organización, utilizando los distintos canales que en cada caso se requieran; además, favorecer el establecimiento de relaciones mutuamente benefi...',9),
(56,'Administración del tiempo',1,'Capacidad para establecer con criterio prioridades a la hora de ejecutar esquemas, basándose en la visión proyectada para planificar estrategias que minimicen el tiempo de la actividad y optimicen el desarrollo de las tareas.',9),
(57,'Análisis de problemas',1,'Capacidad para trascender de lo lógico a lo abstracto y encontrar las verdaderas causas y soluciones de una situación o problema especifico; cuyos resultados son sustentados con un alto nivel de eficacia y confiabilidad.',9),
(58,'Análisis numérico',1,'Capacidad para trascender de lo lógico a lo abstracto y encontrar las verdaderas causas y soluciones de una situación o problema especifico; cuyos resultados son sustentados con un alto nivel de eficacia y confiabilidad.',9),
(59,'Aptitud verbal',1,'Habilidad para expresarse eficazmente dando muestras de manejar un lenguaje profesional y técnico con un tono muy espontáneo, acorde a su nivel de formación y experiencia, así como del nivel del cargo que ocupe, lo que incide directamente en el nivel...',9),
(60,'Atención al cliente',1,'Exceder las expectativas del cliente demostrando un compromiso total en la identificación de cualquier problema y proporcionando las soluciones efectivas para la solución del mismo.',9),
(61,'Autoconfianza',1,'Capacidad para demostrar un alto nivel de seguridad y confianza en las capacidades de si mismo, aplicándolas al logro de los objetivos fijados, movilizando todo su potencial cognitivo y emocional, convencido de que el éxito depende de sí mismo y de c...',9),
(62,'Autocontrol',1,'Capacidad de mantener las propias emociones bajo control y evitar reacciones negativas ante provocaciones, oposición u hostilidad por parte de otros o bajo condiciones de estrés.',9),
(63,'Autodesarrollo',1,'Es la competencia relacionada con el crecimiento personal y el fortalecimiento de las capacidades personales. Capacidad para aprovechar las oportunidades de aprender de la propia experiencia o de la de otros o de lo que se realiza en el entorno. Buscar h...',9),
(64,'Automotivación',1,'Disposición para demostrar una alta capacidad de emprendimiento para realizar las actividades por encima de las exigencias establecidas, mejorar e incrementar los resultados, evitar problemas o encontrar nuevas oportunidades.',9),
(65,'Asunción de riesgos',1,'Capacidad para emprender y asumir acciones que envuelvan un riesgo deliberado con el objeto de lograr un beneficio o una ventaja importante.',9),
(66,'Búsqueda de información',1,'Inquietud y curiosidad por buscar información más allá de las preguntas rutinarias o de lo que se requiere en el puesto.',9),
(67,'Búsqueda de la excelencia',0,'Es el compromiso con la eficiencia y eficacia. Las personas que poseen esta actitud se caracterizan porque: Hacen su trabajo cada día mejor, aún si tienen que asumir más trabajo. No están satisfechas con las cosas como están y buscan mejorarlas. No ...',9),
(68,'Capacidad de análisis',1,'Capacidad para identificar, comprender y evaluar las diferentes variables que inciden en la consecución de un objetivo, determinando las posibles alternativas de viabilidad y teniendo en cuenta su repercusión en los niveles de calidad y eficiencia esp...',9),
(69,'Capacidad para aprender',1,'Habilidad para adquirir y asimilar nuevos conocimientos y destrezas con el fin de utilizarlos en la práctica laboral. Capacidad para captar y asimilar con facilidad conceptos e informaciones simples y complejas.',9),
(70,'Capacidad crítica',1,'Habilidad para la evaluación de datos y líneas de actuación, así como para tomar decisiones lógicas de una manera imparcial y desde un punto de vista racional.',9),
(71,'Capacidad de decisión',1,'Disposición y habilidad para tomar decisiones acertadas basadas en análisis propios de la situación, logrando asumir con responsabilidad y madurez los riesgos del caso.',9),
(72,'Capacidad de gestión',1,'Es la habilidad que tiene la persona para gestionar las tareas y procesos a su cargo en forma rápida y confiable; haciendo uso de la recursividad y dinamismo que requiere el hacer que las cosas resulten.',9),
(73,'Capacidad de negociación',1,'Capacidad para llegar a acuerdos ventajosos a través del intercambio de información, debate de ideas y utilización de estrategias efectivas con personas o grupos que puedan representar de alto interés para la organización.',9),
(74,'Comprensión interpersonal',1,'Es la habilidad para escuchar y entender correctamente los pensamientos, sentimientos o preocupaciones de los demás aunque no se expresen verbalmente o se expresen parcialmente, pero que requieren ser captados por los demás.',9),
(75,'Compromiso',1,'Esfuerzo permanente hacia la consecución de un objetivo, lo cual implica un alto grado de integración de la disposición física, emocional e intelectual de un sujeto sobre lo que desea conseguir, sea a beneficio propio o común.',9),
(76,'Comunicación efectiva',1,'Es la competencia que posee el líder para escuchar, entender y valorar con empatía información, ideas y opiniones que su equipo le comunique, siendo capaz de retroalimentar asertivamente el proceso comunicativo.',9),
(77,'Comunicación escrita',1,'Capacidad para redactar las ideas claramente y de forma gramaticalmente correcta de manera que sean entendidas sin lugar a dudas.',9),
(78,'Comunicación interpersonal',1,'Capacidad para generar y mantener un flujo de comunicación adecuado entre los miembros del grupo o de la organización, utilizando los distintos canales que en cada caso se requieran; además, favorecer el establecimiento de relaciones mutuamente benefi...',9),
(79,'Comunicación oral persuasiva',1,'Capacidad para expresar ideas o hechos claramente y de una manera persuasiva. Convencer a los otros del punto de vista propio.',9),
(80,'Conocimiento del entorno:',1,'Es la competencia que posee el líder para incluir en la toma de decisiones aquellas variables que afectan directa e indirectamente el normal desempeño de la organización y que permitan una ventaja competitiva de la misma en el sector, siendo congruent...',9),
(81,'Conocimiento organizacional',1,'Capacidad para comprender e interpretar las situaciones que afectan directamente a la realidad organizacional, así como para demostrar el alto nivel de conocimiento de todos los procesos operativos, funcionales y de servicio de la compañía como estrat...',9),
(82,'Creatividad',1,'Capacidad para proponer soluciones y/o alternativas novedosas e imaginativas para el mejoramiento de procesos funcionales, estrategias promociónales, entre otras. Las personas que poseen esta habilidad se caracterizan por que proponen y encuentran forma...',9),
(83,'Defensa de los demás',1,'Disposición para actuar a favor o en beneficio de los demás sin que ello se les haya pedido.',9),
(84,'Delegación',1,'Capacidad para distribuir eficazmente la toma de decisiones y de otras responsabilidades hacia el subordinado más adecuado.',9),
(85,'Desarrollo de interrelaciones',1,'Capacidad para establecer y mantener relaciones cordiales, recíprocas y cálidas o redes de contacto con distintas personas.',9),
(86,'Desarrollo de personas',1,'Capacidad para dirigir el proceso de aprendizaje o el desarrollo de los demás a partir de un apropiado análisis de sus necesidades y de la organización. Se centra en el interés por desarrollar a las personas, no en el de proporcionar formación.',9),
(87,'Disponibilidad',1,'Capacidad para trabajar eficazmente en distintas y variadas situaciones.',9),
(88,'Dirección de personas',1,'Capacidad para hacer que otras personas actúen según nuestros deseos utilizando apropiada y adecuadamente el poder personal o la autoridad que el puesto nos confiere. Incluye el "decir a los demás lo que tienen que hacer".',9),
(89,'Efectividad',1,'Capacidad para lograr los máximos resultados de calidad con el mínimo agotamiento del recurso humano y técnico, utilizando la comunicación efectiva, la motivación y la participación conjunta de sus colaboradores.',9),
(90,'Energía',1,'Capacidad para crear y mantener un ritmo de actividad indicado. Muestra el control, la resistencia y la capacidad de trabajar arduamente.',9),
(91,'Entusiasmo',1,'Es la energía y la disposición que se tiene para realizar una labor, colmada por un positivismo y optimismo único, bajo el convencimiento y el dinamismo necesario orientado hacia la consecución de un objetivo particular.',9),
(92,'Escucha',1,'Disposición y capacidad para recibir y entender cualquier tipo de información importante de una comunicación oral entre dos o varias personas.',9),
(93,'Espíritu comercial',0,'Capacidad para entender aquellos puntos claves del negocio que afectan a la rentabilidad y al crecimiento de una empresa y para actuar de manera persistente para alcanzar el éxito comercial a su cargo.',9),
(94,'Espíritu emprendedor',1,'Es la competencia que le permite al líder la búsqueda constante de oportunidades en el entorno para garantizar la viabilidad de los objetivos empresariales generando en sus colaboradores el mismo espíritu gestor de nuevas acciones que propendan por un...',9),
(95,'Espíritu emprendedor',1,'Es la competencia que le permite al líder la búsqueda constante de oportunidades en el entorno para garantizar la viabilidad de los objetivos empresariales generando en sus colaboradores el mismo espíritu gestor de nuevas acciones que propendan por un...',9),
(96,'Ética',1,'Hace referencia a la interiorización de normas y principios morales que hacen responsable al individuo de su propio bienestar y del de los demás mediante un comportamiento basado en conductas socialmente aceptadas. Las personas que poseen esta competen...',9),
(97,'Empoderamiento',1,'Es la capacidad para asumir una responsabilidad con un profundo sentido de compromiso y autonomía personal. Competencia del líder que propicia la participación de su grupo de trabajo, haciendo que estos hagan contribuciones importantes, sean creativos...',9),
(98,'Flexibilidad',1,'Es la habilidad de adaptarse y trabajar eficazmente en distintas y variadas situaciones y con personas o grupos diversos. Incluye una disposición a cambiar de enfoque o de la manera de concebir la realidad, buscando una mejor forma de hacer las cosas; a...',9),
(99,'Gestión del cambio',1,'Es la capacidad para diagnosticar, diseñar y dirigir procesos de cambio específicos que contribuyan significativamente a la productividad grupal y empresarial.',9),
(100,'Gestión de recursos',1,'Capacidad para optimizar y rentabilizar los recursos humanos, técnicos y económicos de que se dispone, con el objetivo de mejorar los procesos, procedimientos y métodos de trabajo y contribuir a la eficacia y agilidad de los sistemas de gestión.',9),
(101,'Gestión de conflictos',1,'Capacidad para resolver eficazmente situaciones, hechos o conflictos en los que se ponen en juego intereses que pueden afectar a las relaciones entre personas o poner en riesgo los objetivos, los intereses o la imagen de la organización.',9),
(102,'Habilidad de control',1,'Capacidad para diseñar estrategias que conlleven a controlar los métodos, personas y asuntos que requieran de medidas de seguimiento; implica la toma decisiones que aseguren este control.',9),
(103,'Identificación con la compañía',1,'Capacidad y voluntad de orientar los propios intereses y comportamientos hacia las necesidades, prioridades y objetivos de la compañía.',9),
(104,'Impacto',1,'Se traduce en causar buena impresión en los otros y mantener esa impresión a lo largo del tiempo.',9),
(105,'Innovación',1,'Es la competencia que posee el líder para concebir y realizar tareas nuevas e inexistentes con el propósito de diseñar y generar nuevos procesos con mayores niveles de rentabilidad y eficiencia.',9),
(106,'Influencia',1,'Implica la atención de persuadir, convencer, influir o impresionar a los demás para que contribuyan a alcanzar los objetivos propios. Está basada en el deseo de causar un efecto específico en los demás, una impresión determinada o una actuación c...',9),
(107,'Iniciativa',1,'Capacidad para actuar de manera preactiva ante determinada situación. Incluye saber identificar un problema - obstáculo u oportunidad y llevar a cabo acciones que contribuyan a su solución.',9),
(108,'Integridad',1,'Capacidad para mantenerse dentro de las normas éticas y morales socialmente aceptadas; así como de actuar en consonancia con lo que cada uno considera importante. Incluye el comunicar las intenciones, ideas y sentimientos abierta y directamente, y el e...',9),
(109,'Interés por mantenerse actualizado',1,'Es la competencia que posee el líder referida al aprendizaje continuo de procesos que permiten implementar nuevos conceptos y metodologías. Compromiso con la promoción del aprendizaje organizacional.',9),
(110,'Interactuar/interrelacionarse',1,'Capacidad para establecer, mantener y potenciar relaciones de valor en el trabajo con personas y grupos, tanto internos como externos, haciendo de estas relaciones un cauce para el logro y alineamiento estratégico de los objetivos de la organización.',9),
(111,'Lealtad y sentido de pertenencia',1,'Se refiere a defender y promulgar los intereses de las organizaciones donde laboran como si fueran propios. Se aprecia gran sentido de identificación con los objetivos de la organización a tal forma que suelen anteponer los intereses organizacionales a...',9),
(112,'Liderazgo',1,'Capacidad para dirigir a las personas y lograr que éstas contribuyan de forma efectiva y adecuada a la consecución de los objetivos. Comprometerse en el desarrollo de sus colaboradores, su evaluación y la utilización del potencial y las capacidades i...',9),
(113,'Manejo de la incertidumbre y la complejidad',1,'Capacidad para discernir, evaluar con objetividad y tomar decisiones efectivas en escenarios caracterizados por el riesgo, la incertidumbre y complejidad.',9),
(114,'Meticulosidad',1,'Resolución total de una tarea o asunto hasta el final y en todas las áreas que envuelva, independientemente de su insignificancia.',9),
(115,'Minuciosidad en la preparación (para una presentación)',1,'Resolución total de una tarea o asunto hasta el final y en todas las áreas que envuelva, independientemente de su insignificancia.',9),
(116,'Negociación y manejo de conflictos',1,'Es la competencia que posee un líder para plantear soluciones y resolver diferencias de ideas u opiniones de las partes, apoyándose en la suficiente autoridad y justicia, centrándose en los intereses comunes, tratando de conciliar y mediar de manera e...',9),
(117,'Niveles de trabajo',1,'Establecimiento de grandes metas o modelos de conducta para uno mismo, para los otros y para la empresa.',9),
(118,'Orientación al cliente',1,'Implica un deseo de ayudar o servir a los clientes, de satisfacer sus necesidades, de dirigir todas sus acciones en la búsqueda de satisfacción de los mismos.',9),
(119,'Orientación al logro',1,'Es la preocupación por realizar bien el trabajo, por cumplir con un objetivo propuesto. Por realizar algo único y excepcional.',9),
(120,'Orientación al servicio',1,'Es la disposición para realizar el trabajo con base en el conocimiento de las necesidades y expectativas de los clientes externos e internos, reflejando un trato amable y cordial, interés por la persona y por la solución a sus problemas.',9),
(121,'Orientación estratégica',1,'Es la habilidad de vincular visiones a largo plazo y diseñar acciones tenientes al diseño de planes estratégicos que consoliden la misión y la visión de la organización a corto, mediano y largo plazo.',9),
(122,'Orientación estratégica',1,'Es la habilidad de vincular visiones a largo plazo y diseñar acciones tenientes al diseño de planes estratégicos que consoliden la misión y la visión de la organización a corto, mediano y largo plazo.',9),
(123,'Pensamiento analítico',1,'Es la capacidad de entender una situación, desagregándola en pequeñas partes o identificando sus implicaciones paso a paso. Incluye el organizar las partes de un problema o situación de forma sistemática al realizar comparaciones entre diferentes el...',9),
(124,'Pensamiento conceptual',1,'Capacidad para identificar en las situaciones pautas o relaciones que no son obvias o identificar puntos clave en situaciones complejas. Incluye la utilización de un razonamiento creativo, inductivo o conceptual.',9),
(125,'Pensamiento creativo',1,'Capacidad para generar, descubrir y transformar nuevas ideas en soluciones útiles y eficaces aplicables en la organización.',9),
(126,'Pensamiento estratégico',1,'Es la capacidad para determinar la posición competitiva de la empresa, mediante un análisis profundo de todos los factores internos y externos para establecer estrategias integrales que vinculen toda la organización.',9),
(127,'Pensamiento ético',1,'Es la competencia que el líder posee para valorar los eventos internos y externos de la empresa basándose en los valores personales y morales, una mentalidad limpia y transparente a la hora de administrar; honestidad, equidad, cumplimiento de normas y ...',9),
(128,'Pensamiento sistémico',1,'Es la competencia que posee el líder referenciada a un enfoque integral, que concibe el funcionamiento general de la empresa interrelacionando y afectando cada una de sus áreas y componentes, y que por lo tanto toda decisión incide en el sistema, en e...',9),
(129,'Persistencia',1,'Es la tenacidad, la insistencia permanente para lograr un propósito y no desfallecer hasta conseguirlo.',9),
(130,'Planificación y control',1,'Capacidad para determinar de forma eficaz, fases, etapas, metas y prioridades para la consecución de objetivos, a través del desarrollo de planes de acción, incluyendo los recursos necesarios y los sistemas de control.',9),
(131,'Planificación y organización',1,'Capacidad para establecer eficazmente un orden apropiado de actuación personal o para terceros con el objetivo de alcanzar una meta.',9),
(132,'Positivismo',1,'Capacidad de pensamiento que tiene un sujeto y que está directamente relacionado con la confianza en el éxito de un trabajo, una idea o tarea.',9),
(133,'Preocupación por el desarrollo',1,'Implica la intención de fomentar el aprendizaje o desarrollo de las personas con un adecuado análisis de necesidades. El énfasis está más en la intención de desarrollar que en un rol formal en el área de formación.',9),
(134,'Preocupación por el orden y la calidad',1,'Disposición por mantener patrones de organización y eficacia en todo lo que lo rodea en niveles personal y laboral.',9),
(135,'Preocupación por la imagen y el impacto de la organización',1,'Ser conscientes de cómo los demás perciben nuestra imagen y nuestro rol en la organización y de la forma como esta influye en el nivel de aceptación y en la impresión misma de la empresa interna y externamente.',9),
(136,'Profesionalismo',1,'Se refiere a divulgar los estándares de comportamiento a través de las propias acciones. Aquellos que tienen esta competencia mantienen una imagen de alto profesionalismo en todo lo que hacen.',9),
(137,'Resistencia',1,'Capacidad para mantenerse eficaz en situaciones de decepción y/o rechazo.',9),
(138,'Responsabilidad',1,'Hace referencia al compromiso, a un alto sentido del deber, al cumplimiento de las obligaciones en las diferentes situaciones de la vida.',9),
(139,'Rigor profesional',1,'Capacidad para utilizar la información, las normas, los procedimientos y las políticas de la empresa con precisión y eficacia, con objeto de lograr los estándares de calidad, en tiempo y forma, con eficacia y eficiencia, en consonancia con los valore...',9),
(140,'Sensibilidad hacia el cliente',1,'Capacidad para orientar y enfocar la actividad hacia las necesidades de los clientes internos o externos, en cualquier ámbito funcional de la empresa.',9),
(141,'Sensibilidad interpersonal',1,'Conocimiento de los demás, del entorno y de sus necesidades.',9),
(142,'Sensibilidad medioambiental',1,'Capacidad para enfocar la prestación de los servicios, mejorando y respetando las condiciones medioambientales, a través de la búsqueda de la compatibilidad entre las demandas sociales y las líneas estratégicas de la organización.',9),
(143,'Sensibilidad organizacional',1,'Capacidad para implicarse en el Proyecto de Empresa, poniendo a disposición de ella los conocimientos y habilidades para la consecución de los objetivos establecidos.',9),
(144,'Sentido de efectividad',1,'Capacidad para orientar la actividad en la consecución de los objetivos previstos e implicando de forma activa a los colaboradores en retos y metas de excelencia profesional y de calidad.',9),
(145,'Utilización de otros como recurso',1,'Implica la intención de colaborar y cooperar con otros, formar parte del grupo, trabajar juntos, como opuesto a hacerlo individual o competitivamente.',9),
(146,'Utilización de otros como recurso',1,'Se refiere a una compleja interacción con los empleados autónomos que trabajan a tiempo parcial para la empresa y demás personas que no están sujetos a influencias de poder por la posición que ocupan.',9),
(147,'Utilización de relaciones',1,'Define cómo el personal comercial puede utilizar las relaciones familiares, profesionales o de amistad para conseguir negocios.',9),
(148,'Visión de futuro',1,'Es la capacidad de visualizar las tendencias del medio con una actitud positiva y optimista, así orientar su conducta a la consecución de metas.',9),
(149,'Visión empresarial',1,'Capacidad para anticiparse a las necesidades futuras con criterios estratégicos, simulando nuevos escenarios de actuación en mercados y productos, formulando los pasos a seguir a mediano y largo plazo, con objeto de encontrar oportunidades de negocio q...',9),
(150,'Visión prospectiva',1,'Capacidad para visualizar el futuro hacia donde llegar, identificando estrategias, previendo consecuencias y anticipándose a los hechos que pueden generar riesgos en las acciones empresariales que se implementen',9),
(151,'Femenino',1,'sexo',10),
(152,'Masculino',1,'sexo',10),
(153,'Indistinto',1,'sexo',10),
(154,'Soltero',1,'Estado civil',11),
(155,'Casado',1,'Estado civil',11),
(156,'Unió Libre',1,'Estado civil',11),
(157,'Divorciado',1,'Estado civil',11),
(158,'Cuantitativa',1,'El encuestado seleecciona su respuesta en  una escala de 1 a 5',12),
(159,'Cualitativa',1,'El encuestado seleccióna su respuesta de una serie de textos que tienen una abstracción lógica del nivel o grado que desea dar a su respuesta',12),
(160,'Lógica',1,'Su respuesta es "si" o "no"',12),
(161,'Abierta',1,'La respuesta es un texto libre donde el encestado puede dar su opinión',12),
(162,'AMERICANA',1,'NULL',13),
(163,'ARGENTINA',1,'NULL',13),
(164,'BOLIVIANA',1,'NULL',13),
(165,'CANADIENSE',1,'NULL',13),
(166,'CHILENA',1,'NULL',13),
(167,'CHINA',1,'NULL',13),
(168,'COLOMBIANA',1,'NULL',13),
(169,'CUBANA',1,'NULL',13),
(170,'ESPAÑOLA',1,'NULL',13),
(171,'FRANCESA',1,'NULL',13),
(172,'GUATEMALTECA',1,'NULL',13),
(173,'INDU',1,'NULL',13),
(174,'IRLANDES',1,'NULL',13),
(175,'JANONESA',1,'NULL',13),
(176,'MEXICANA',1,'NULL',13),
(177,'RUSA',1,'NULL',13),
(178,'Becario',1,'NULL',14),
(179,'Analista',1,'NULL',14),
(180,'Consultor Junior',1,'NULL',14),
(181,'Consultor Semisenior ',1,'NULL',14),
(182,'Consultor Senior',1,'NULL',14),
(183,'Gerente de Operaciones ',1,'NULL',14),
(184,'Analista Ventas',1,'NULL',14),
(185,'Consultor Ventas  Junior',1,'NULL',14),
(186,'Consultor Ventas  Semisenior',1,'NULL',14),
(187,'Consultor Ventas  Senior',1,'NULL',14),
(188,'Gerente Ventas',1,'NULL',14),
(189,'PADRE',1,'NULL',15),
(190,'MADRE',1,'NULL',15),
(191,'HERMANO/HERMANA',1,'NULL',15),
(192,'ESPOSO/ESPOSA',1,'NULL',15),
(193,'HIJO/HIJA',1,'NULL',15),
(194,'ABUELO/ABUELA',1,'NULL',15),
(195,'NIETO/NIETA',1,'NULL',15),
(196,'TÍO/TIA',1,'NULL',15),
(197,'AMIGO/AMIGA',1,'NULL',15),
(198,'CONCUBINO/CONCUBINA',1,'NULL',15),
(199,'OTRO',1,'NULL',15),
(200,'ABC CAPITAL',1,'NULL',16),
(201,'ACTINVER',1,'NULL',16),
(202,'AFIRME',1,'NULL',16),
(203,'AUTOFIN',1,'NULL',16),
(204,'AZTECA',1,'NULL',16),
(205,'BAJIO',1,'NULL',16),
(206,'BANCO FAMSA',1,'NULL',16),
(207,'BANCOMER',1,'NULL',16),
(208,'BANCOPPEL',1,'NULL',16),
(209,'BANJERCITO',1,'NULL',16),
(210,'BANORTE',1,'NULL',16),
(211,'BANORTE/IXE',1,'NULL',16),
(212,'BANREGIO',1,'NULL',16),
(213,'BANSEFI',1,'NULL',16),
(214,'BANSI',1,'NULL',16),
(215,'BRADESCARD DE MEXICO',1,'NULL',16),
(216,'BROXEL',1,'NULL',16),
(217,'CIBANCO',1,'NULL',16),
(218,'DONDE',1,'NULL',16),
(219,'HSBC',1,'NULL',16),
(220,'INBURSA',1,'NULL',16),
(221,'IXE',1,'NULL',16),
(222,'MULTIVA BANCO',1,'NULL',16),
(223,'SANTANDER',1,'NULL',16),
(224,'SCOTIABANK',1,'NULL',16),
(225,'PRIMARIA TRUNCA',1,'NULL',17),
(226,'PRIMARIA COMPLETA',1,'NULL',17),
(227,'SECUNDARIA TRUNCA',1,'NULL',17),
(228,'SECUNDARIA COMPLETA',1,'NULL',17),
(229,'CARRERA TECNICA INCOMPLETA ',1,'NULL',17),
(230,'CARRERA TECNICA COMPLETA ',1,'NULL',17),
(231,'BACHILLERATO INCOMPLETO',1,'NULL',17),
(232,'BACHILLERATO COMPLETO',1,'NULL',17),
(233,'UNIVERSIDAD INCOMPLETA',1,'NULL',17),
(234,'UNIVERSIDAD COMPLETA',1,'NULL',17),
(235,'MAESTRIA INCOMPLETA',1,'NULL',17),
(236,'MAESTRIA COMPLETA',1,'NULL',17),
(237,'DOCTORADO INCOMPLETO',1,'NULL',17),
(238,'DOCTORADO COMPLETO',1,'NULL',17),
(239,'UNIVERSITARIO TECNICO INCOMPLETO',1,'NULL',17),
(240,'UNIVERSITARIO TECNICO COMPLETO',1,'NULL',17),
(241,'OTRO',1,'NULL',17),
(242,'Sociabilidad',1,'Capacidad para mezclarse fácilmente con otras personas y establecer con ellas relaciones altamente satisfactorias a nivel personal, social y laboral.',18),
(243,'Tolerancia al estrés',1,'Mantenimiento firme del carácter bajo presión y/o oposición. Se traduce en respuestas controladas en situaciones de estrés.',18),
(244,'Toma de decisiones',1,'Capacidad para elegir entre varias alternativas aquellas más viables para la consecución de objetivos, basándose en un análisis exhaustivo de los posibles efectos y riesgos, además de la visualización de las posibilidades de implantación.',18),
(245,'Trabajo en equipo y cooperación',1,'Implica la intención de colaborar y cooperar con otros, formar parte del grupo, trabajar juntos, como opuesto a hacerlo individual o competitivamente.',18),
(246,'INFONAVIT',1,'NULL',20),
(247,'FOVISSSTE',1,'NULL',20),
(248,'FONACOT',1,'NULL',20),
(249,'OTRO',1,'NULL',20),
(250,'De ley',1,'Prestaciones',21),
(251,'Superiores de ley',1,'Prestaciones',21),
(252,'Honorarios',1,'Prestaciones',21),
(253,'Salarios asimilados',1,'Prestaciones',21),
(254,'Comisionista',1,'Prestaciones',21),
(255,'Becario',1,'Prestaciones',21),
(256,'Servicio social',1,'Prestaciones',21),
(257,'otro',1,'Prestaciones',21),
(258,'Por proyecto',1,'Tipo de  contrato',22),
(259,'Por incapacidad',1,'Tipo de  contrato',22),
(260,'Tiempo determinsdo',1,'Tipo de  contrato',22),
(261,'Tiempo Indeterminado',1,'Tipo de  contrato',22),
(262,'Por evaluación',1,'Tipo de  contrato',22),
(263,'Plaza de nueva creación',1,'Motivo de vacante',23),
(264,'Incapacacidad',1,'Motivo de vacante',23),
(265,'Proyecto',1,'Motivo de vacante',23),
(266,'Substitución',1,'Motivo de vacante',23),
(267,'Expansión',1,'Motivo de vacante',23),
(268,'Otro',1,'Motivo de vacante',23),
(269,'Mensual',1,'NULL',24),
(270,'Bimestral',1,'NULL',24),
(271,'Semanal',1,'NULL',24),
(272,'Anual',1,'NULL',24);
...
INSERT INTO `clb_submodulo` VALUES (1,'Bandeja de Proyectos'),(2,'Alta de Proyecto'),(3,'Asignar Periodo Y Garantía'),(4,'Asignar Consultor'),(5,'Configurar Cuestionario'),(7,'Organigrama'),(6,'Cargar Head Count'),(8,'Enviar Cuestionarios'),(9,'Gráficas de Resultados');
