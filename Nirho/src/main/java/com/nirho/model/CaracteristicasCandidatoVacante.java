 ...
 */
@Entity
@Table(name = "caracteristicas_candidato_vacante")
public class CaracteristicasCandidatoVacante implements Serializable {
    ...
    public CaracteristicasCandidatoVacante() {
    }

    public CaracteristicasCandidatoVacante(Long id) {
        this.id = id;
    }

    public CaracteristicasCandidatoVacante(Long id, String cambioResidencia, String caractAdicionales, String carrera, String certificaciones, String cursos, String discapacitados, String dispoViajar, byte[] edadRango, String especialidad, String estadoCivil, String genero, int nivelEstudios, String oCapacidades, String oficios, String titulo) {
        this.id = id;
	...
	public String toString() {
		return "CaracteristicasCandidatoVacante [id=" + id + ", cambioResidencia=" + cambioResidencia
				...
				+ dispoViajar + ", edadRango=" + Arrays.toString(edadRango) + ", especialidad=" + especialidad
				+ ", estadoCivil=" + estadoCivil + ", genero=" + genero + ", nivelEstudios=" + nivelEstudios
				+ ", oCapacidades=" + oCapacidades + ", oficios=" + oficios + ", titulo=" + titulo + ", vacante="
				+ vacante + "]";
	}
