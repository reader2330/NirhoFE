...
@Component({
  selector: 'app-data-contact-360',
  templateUrl: './data-contact-360.component.html',
  styleUrls: ['./data-contact-360.component.scss']
})
export class DataContact360Component implements OnInit {
