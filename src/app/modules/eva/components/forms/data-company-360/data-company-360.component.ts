...
@Component({
  selector: 'app-data-company-360',
  templateUrl: './data-company-360.component.html',
  styleUrls: ['./data-company-360.component.scss']
})
export class DataCompany360Component implements OnInit {
