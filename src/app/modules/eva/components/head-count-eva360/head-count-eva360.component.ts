...
@Component({
  selector: 'app-head-count-eva360',
  templateUrl: './head-count-eva360.component.html',
  styleUrls: ['./head-count-eva360.component.scss']
})
export class HeadCountEva360Component implements OnInit {
  ...
  constructor(breakpointObserver: BreakpointObserver, private CatalogService: CatalogsService, private ProyectEvdServices: Proyecto360Service) {
