...
@Component({
  selector: 'app-data-period-eva360',
  templateUrl: './data-period-eva360.component.html',
  styleUrls: ['./data-period-eva360.component.scss']
})
export class DataPeriodEva360Component implements OnInit {
  ...
  constructor(breakpointObserver: BreakpointObserver, private ProyectService: Proyecto360Service) {
