...
@Component({
  ...
  templateUrl: './cuestionario-select-pvc.component.html',
  styleUrls: ['./cuestionario-select-pvc.component.scss']
})
export class CuestionarioSelectPvcComponent implements OnInit {
