...
@Component({
  selector: 'app-data-project-pvc',
  templateUrl: './data-project-pvc.component.html',
  styleUrls: ['./data-project-pvc.component.scss']
})
export class DataProjectPvcComponent implements OnInit {
  ...
  constructor(breakpointObserver: BreakpointObserver, private CatalogService: CatalogsService, private ProyectoService: ProyectoPVCService) {
