...
@Component({
  selector: 'app-data-contact-pvc',
  templateUrl: './data-contact-pvc.component.html',
  styleUrls: ['./data-contact-pvc.component.scss']
})
export class DataContactPvcComponent implements OnInit {
