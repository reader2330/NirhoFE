...
@Component({
  ...
  templateUrl: './organizational-development-modal-irh.component.html',
  styleUrls: ['./organizational-development-modal-irh.component.scss']
})
export class OrganizationalDevelopmentModalIrhComponent implements OnInit {
  mobile = false;
  enterprise = {
    id: null,
    name: '',
